...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "6209058655:AAHqjX8WsqKSNB2Gww1m90AMhCWUO6lniY0"
else:
    tgkey = tgenv
print(tgenv)
...
qcache = None
chat_log = None
botname = 'AI Answer Machine Bot'
username = 'ai_answer_machine_bot'
